# airflow/dags/dag_classification_maturity.py
"""
...
from classification_config import MATURITY_CONFIG
...
# ============================================================================
# DAG : Training model : classification by maturity
# ============================================================================
@dag(
    dag_id='maturity_classification_only',
    default_args={
    ...
    catchup=False,
    tags=['classification', 'maturity', 'production']
)
def maturity_classification_only():
...
# Créer le DAG
maturity_dag = maturity_classification_only()